...
the nf-core pipeline `nf-core-rnafusion` version `4.1.0`.

## Overview

- Pipeline website: [https://nf-co.re/rnafusion](https://nf-co.re/rnafusion)
- Pipeline source repository: [https://github.com/nf-core/rnafusion](https://github.com/nf-core/rnafusion)
