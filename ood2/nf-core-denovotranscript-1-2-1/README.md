# nf-core/denovotranscript Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-denovotranscript` version `1.2.1`.

## Overview

- Pipeline website: [https://nf-co.re/denovotranscript](https://nf-co.re/denovotranscript)
- Pipeline source repository: [https://github.com/nf-core/denovotranscript](https://github.com/nf-core/denovotranscript)
