# nf-core/differentialabundance Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-differentialabundance` version `1.5.0`.

## Overview

- Pipeline website: [https://nf-co.re/differentialabundance](https://nf-co.re/differentialabundance)
- Pipeline source repository: [https://github.com/nf-core/differentialabundance](https://github.com/nf-core/differentialabundance)
