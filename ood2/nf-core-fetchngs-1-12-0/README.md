# nf-core/fetchngs Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-fetchngs` version `1.12.0`.

## Overview

- Pipeline website: [https://nf-co.re/fetchngs](https://nf-co.re/fetchngs)
- Pipeline source repository: [https://github.com/nf-core/fetchngs](https://github.com/nf-core/fetchngs)
