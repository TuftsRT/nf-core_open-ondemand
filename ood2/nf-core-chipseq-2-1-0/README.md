# nf-core/chipseq Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-chipseq` version `2.1.0`.

## Overview

- Pipeline website: [https://nf-co.re/chipseq](https://nf-co.re/chipseq)
- Pipeline source repository: [https://github.com/nf-core/chipseq](https://github.com/nf-core/chipseq)
