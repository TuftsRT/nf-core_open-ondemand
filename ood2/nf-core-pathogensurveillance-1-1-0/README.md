# nf-core/pathogensurveillance Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-pathogensurveillance` version `1.1.0`.

## Overview

- Pipeline website: [https://nf-co.re/pathogensurveillance](https://nf-co.re/pathogensurveillance)
- Pipeline source repository: [https://github.com/nf-core/pathogensurveillance](https://github.com/nf-core/pathogensurveillance)
