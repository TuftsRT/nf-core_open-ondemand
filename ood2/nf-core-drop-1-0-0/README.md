# nf-core/drop Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-drop` version `1.0.0`.

## Overview

- Pipeline website: [https://nf-co.re/drop](https://nf-co.re/drop)
- Pipeline source repository: [https://github.com/nf-core/drop](https://github.com/nf-core/drop)
