const iconMap = {
  ...
  "process skipping options": "fa fa-fw me-2 fas fa-fast-forward svelte-1jrxhr2",
  ...
  "alignment compression options": "fa fa-fw me-2 fas fa-map-signs svelte-1jrxhr2",
  ...
  "quality control options": "fa fa-fw me-2 fas fa-check-circle svelter-1jrxhr2",
  "peak calling options": "fa fa-fw me-2 fas fa-chart-area svelte-1jrxhr2",
  "preprocessing general qc options": "fa fa-fw me-2 fas fa-users-cog svelte-1jrxhr2",
  "preprocessing short-read qc options": "fa fa-fw me-2 fas fa-compress-alt svelte-1jrxhr2",
  "preprocessing long-read qc options": "fa fa-fw me-2 fas fa-compress-alt svelte-1jrxhr2",
  "redundancy estimation": "fa fa-fw me-2 fas fa-chart-line svelte-1jrxhr2",
  "preprocessing host removal options": "fa fa-fw me-2 fas fa-user-times svelte-1jrxhr2",
  "preprocessing run merging options": "fa fa-fw me-2 fas fa-clipboard-check svelte-1jrxhr2",
  "profiling options": "fa fa-fw me-2 fas fa-align-center svelte-1jrxhr2",
  "postprocessing and visualisation options": "fa fa-fw me-2 fas fa-chart-line svelte-1jrxhr2",
  "save intermediate files": "fa fa-fw me-2 fas fa-save svelte-1jrxhr2",
  "special library options": "fa fa-fw me-2 fas fa-prescription-bottle svelte-1jrxhr2",
  ...
  "targeted sequencing analysis options": "fa fa-fw me-2 fas fa-bullseye svelte-1jrxhr2",
  ...
  "mandatory arguments": "fa fa-fw me-2 fas fa-exclamation-circle svelte-1jrxhr2",
  ...
  "special library types": "fa fa-fw me-2 fas fa-prescription-bottle svelte-1jrxhr2", 
  ...
  "read trimming and quality filtering": "fa fa-fw me-2 fas fa-ban svelte-1jrxhr2",
  "amplicon sequence variants(asv) calculation": "fa fa-fw me-2 fas fa-braille svelte-1jrxhr2",
  "taxonmoic database": "fa fa-fw me-2 fas fa-braille svelte-1jrxhr2",
  "multi-region taxonomic database": "fa fa-fw me-2 fas fa-braille svelte-1jrxhr2",
  "asv filtering": "fa fa-fw me-2 fas fa-filter svelte-1jrxhr2",
  "downstream analysis": "fa fa-fw me-2 fas fa-bacteria svelte-1jrxhr2",
  "differential abundance analysis": "fa fa-fw me-2 fas fa-bacteria svelte-1jrxhr2",
  "pipeline summary report": "fa fa-fw me-2 fas fa-book-open svelte-1jrxhr2",
  "skipping specified steps": "fa fa-fw me-2 fas fa-fast-forward svelte-1jrxhr2",
  ...
  "Taxonomic classification: general options": "fa fa-fw me-2 fas fa-tag svelte-1jrxhr2",
  "Taxonomic classification: MMseqs2 databases": "fa fa-fw me-2 fas fa-tag svelte-1jrxhr2",
  "Taxonomic classification: MMseqs2 taxonomy": "fa fa-fw me-2 fas fa-tag svelte-1jrxhr2",
  "Annotation: general options": "fa fa-fw me-2 fas fa-file-signature svelte-1jrxhr2",
  ...
  "Protein Annotation: INTERPROSCAN": "fa fa-fw me-2 fas fa-file-signature svelte-1jrxhr2",
  "Database downloading options": "fa fa-fw me-2 fas fa-database svelte-1jrxhr2",
  ...
  "BGC: general options": "fa fa-fw me-2 fas fa-angle-double-right svelte-1jrxhr2",
  ...
  "Observations (e.g. samples) options": "fa fa-fw me-2 fas fa-eye svelte-1jrxhr2",
  ...
  "DESeq2 specific options (RNA-seq only)": "fa fa-fw me-2 fas fa-adjust svelte-1jrxhr2",
  "Limma specific options (microarray only)": "fa fa-fw me-2 fas fa-border-all svelte-1jrxhr2",
  ...
  "Options related to gene set analysis": "fa fa-fw me-2 fas fa-cogs svelte-1jrxhr2",
  "Reporting options": "fa fa-fw me-2 fas fa-chart-line svelte-1jrxhr2",
  "Partial run options": "fa fa-fw me-2 fas fa-angle-double-right svelte-1jrxhr2",
  ...
  "salmon options": "fa fa-fw me-2 fas fa-fish svelte-1jrxhr2",
   ...
   "Multi-region taxonomic database": "fa fa-fw me-2 fas fa-database svelte-1jrxhr2",
   "ASV filtering": "fa fa-fw me-2 fas fa-filter svelte-1jrxhr2",  
   "Downstream analysis": "fa fa-fw me-2 fas fa-bacteria svelte-1jrxhr2",
   "Differential abundance analysis": "fa fa-fw me-2 fas fa-bacteria svelte-1jrxhr2",
   "Pipeline summary report": "fa fa-fw me-2 fas fa-book-open svelte-1jrxhr2",
