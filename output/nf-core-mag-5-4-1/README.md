# nf-core/mag Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-mag` version `5.4.1`.

## Overview

- Pipeline website: [https://nf-co.re/mag](https://nf-co.re/mag)
- Pipeline source repository: [https://github.com/nf-core/mag](https://github.com/nf-core/mag)
