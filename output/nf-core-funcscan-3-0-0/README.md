# nf-core/funcscan Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-funcscan` version `3.0.0`.

## Overview

- Pipeline website: [https://nf-co.re/funcscan](https://nf-co.re/funcscan)
- Pipeline source repository: [https://github.com/nf-core/funcscan](https://github.com/nf-core/funcscan)
