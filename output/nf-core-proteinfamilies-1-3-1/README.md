...
the nf-core pipeline `nf-core-proteinfamilies` version `1.3.1`.

## Overview

- Pipeline website: [https://nf-co.re/proteinfamilies](https://nf-co.re/proteinfamilies)
- Pipeline source repository: [https://github.com/nf-core/proteinfamilies](https://github.com/nf-core/proteinfamilies)
