# nf-core/scrnaseq Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-scrnaseq` version `4.0.0`.

## Overview

- Pipeline website: [https://nf-co.re/scrnaseq](https://nf-co.re/scrnaseq)
- Pipeline source repository: [https://github.com/nf-core/scrnaseq](https://github.com/nf-core/scrnaseq)
