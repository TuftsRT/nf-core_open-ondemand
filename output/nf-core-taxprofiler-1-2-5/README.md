# nf-core/taxprofiler Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-taxprofiler` version `1.2.5`.

## Overview

- Pipeline website: [https://nf-co.re/taxprofiler](https://nf-co.re/taxprofiler)
- Pipeline source repository: [https://github.com/nf-core/taxprofiler](https://github.com/nf-core/taxprofiler)
