# nf-core/rnaseq Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-rnaseq` version `3.26.0`.

## Overview

- Pipeline website: [https://nf-co.re/rnaseq](https://nf-co.re/rnaseq)
- Pipeline source repository: [https://github.com/nf-core/rnaseq](https://github.com/nf-core/rnaseq)
