# nf-core/methylseq Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-methylseq` version `4.1.0`.

## Overview

- Pipeline website: [https://nf-co.re/methylseq](https://nf-co.re/methylseq)
- Pipeline source repository: [https://github.com/nf-core/methylseq](https://github.com/nf-core/methylseq)
