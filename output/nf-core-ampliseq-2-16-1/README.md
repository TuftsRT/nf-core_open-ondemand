# nf-core/ampliseq Open OnDemand App

This directory contains a generated Open OnDemand batch-connect app for running
the nf-core pipeline `nf-core-ampliseq` version `2.16.1`.

## Overview

- Pipeline website: [https://nf-co.re/ampliseq](https://nf-co.re/ampliseq)
- Pipeline source repository: [https://github.com/nf-core/ampliseq](https://github.com/nf-core/ampliseq)
